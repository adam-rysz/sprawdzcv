  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto p-6 text-gray-800 space-y-4 text-justify">
        ...
        <p>
          ATS (Applicant Tracking System) to system oparty na sztucznej inteligencji znacznie wspierający większość rekruterów w przetwarzaniu dużej liczby aplikacji kandydatów.
